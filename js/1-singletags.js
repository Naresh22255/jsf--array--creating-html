...
// starting data
const paragraph =
  "Fusce vel dui. Nunc nulla. Sed mollis, eros et ultrices tempus, mauris ipsum aliquam libero, non adipiscing dolor urna a orci. Morbi ac felis. Curabitur vestibulum aliquam leo.";
...
// create HTML from the data
var htmlString = renderBlockQuote(quote);
/******* Call the function here (instead of the empty string ********/
// add the HTML into the page
document.body.innerHTML += htmlString;
